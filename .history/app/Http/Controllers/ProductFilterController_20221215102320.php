...
class ProductFilterController extends Controller
{
    public function index(){
        ...
        $data = compact('metaDetails','products', 'perPage', 'sortby', 'categoriesArray','brandArray','graphicCardArray', 'hardDriveIdsArray', 'processorIdsArray', 'ramIdsArray', 'screenSizeIdsArray', 'ssdIdsArray', 'typeIdsArray', 'colorIdsArray','priceMin','priceMax');
