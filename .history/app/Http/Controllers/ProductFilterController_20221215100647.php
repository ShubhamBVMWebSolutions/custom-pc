...
class ProductFilterController extends Controller
{
    public function index(){
        ...
        $data = compact('metaDetails','products', 'perPage', 'sortby', 'categoryIds','brandIds','graphicCardIds', 'hardDriveIds', 'processorIds', 'ramIds', 'screenSizeIds', 'ssdIds', 'typeIds', 'colorIds','priceMin','priceMax');
