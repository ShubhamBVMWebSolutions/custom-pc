                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    if($product_rating == 1){
                                     ...
                                     <div class="rate">
    <input type="radio" id="star5_<?=$loop->index?>" class="rating_<?=$loop->index?>"   value="5" checked onchange="updateRating(5,<?=$prod_id?>)"/>
    <label for="star5_<?=$loop->index?>" title="5">5 stars</label>
    <input type="radio" id="star4_<?=$loop->index?>" class="rating_<?=$loop->index?>"   value="4" onchange="updateRating(4,<?=$prod_id?>)"/>
    <label for="star4_<?=$loop->index?>" title="4">4 stars</label>
    <input type="radio" id="star3_<?=$loop->index?>" class="rating_<?=$loop->index?>"   value="3" onchange="updateRating(3,<?=$prod_id?>)"/>
    <label for="star3_<?=$loop->index?>" title="3">3 stars</label>
    <input type="radio" id="star2_<?=$loop->index?>" class="rating_<?=$loop->index?>"   value="2" onchange="updateRating(2,<?=$prod_id?>)"/>
    <label for="star2_<?=$loop->index?>" title="2">2 stars</label>
    <input type="radio" id="star1_<?=$loop->index?>" class="rating_<?=$loop->index?>"   value="1" onchange="updateRating(1,<?=$prod_id?>)"/>
