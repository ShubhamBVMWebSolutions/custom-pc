                                        ...
                                        <div class="shop__sidebar__brand">
                                            <ul>
                                                ...
                                                <li
                                                    ...
                                                    <input id="brand_option_{{$cat->id}}" name="brandIds" value="{{$cat->id}}" class="css-checkbox" type="checkbox" onchange="storeAndSubmit('brandIds','brand_ids')" @if(!empty($brandArray)) @if(in_array($brand->id,$brandArray)) checked @endif @endif />
                                                    <label for="brand_option_{{$cat->id}}" class="css-label" >{{$brand->title}}</label>
                                                </li>
                                                @endforeach
                                            </ul>
