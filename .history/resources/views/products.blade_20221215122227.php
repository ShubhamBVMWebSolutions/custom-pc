                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                ...
                                                <li>
                                                <input id="cat_option_{{$cat->id}}" name="categoryIds" value="{{$cat->id}}" class="css-checkbox" type="checkbox" onchange="this.form.submit()" @if(!empty($categoriesArray)) @if(in_array($cat->id,$categoriesArray)) checked @endif @endif/>
