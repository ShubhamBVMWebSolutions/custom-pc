                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                ...
                                                <li>
                                                <input id="cat_option_{{$cat->id}}" value="{{$cat->id}}" class="css-checkbox" type="checkbox" onchange="this.form.submit()" @if(!empty($categoriesArray)) @if(in_array($cat->id,$categoriesArray)) checked @endif @endif/>
                                                <label for="cat_option_{{$cat->id}}" class="css-label" onclick="">{{$cat->title}}</label>
                                                <!-- <a
