                                        ...
                                        <div class="shop__sidebar__brand">
                                            <ul>
                                                ...
                                                <li
                                                    ...
                                                    <input id="graphic_option_{{$graphic->id}}" name="graphicIds" value="{{$graphic->id}}" class="css-checkbox" type="checkbox" onchange="storeAndSubmit('graphicIds','graphic_ids')" @if(!empty($graphicCardArray)) @if(in_array($graphic->id,$graphicCardArray)) checked @endif @endif />
