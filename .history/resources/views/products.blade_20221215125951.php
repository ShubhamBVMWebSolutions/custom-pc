                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                ...
                                                <li>
                                                <input id="cat_option_{{$cat->id}}" name="catgoryIds" value="{{$cat->id}}" class="css-checkbox" type="checkbox" @if(!empty($categoriesArray)) @if(in_array($cat->id,$categoriesArray)) checked @endif @endif/>
