                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__right">
                                    <p>Showing {{$perPage }} of {{$products->count()}} results</p>
                                    <p>Sort by:</p>
                                    <form method="GET">
                                    <select style="display: none;" name="sort" onchange="this.form.submit()">
                                        <option value="price_asc" @if($sortby == 'price_asc') selected @endif >Price: Low - High</option>
                                        <option value="price_desc" @if($sortby == 'price_desc') selected @endif >Price: High - Low</option>
                                        <option value="new_old" @if($sortby == 'new_old') selected @endif >New - Old</option>
                                        <option value="old_new" @if($sortby == 'old_new') selected @endif >Old - New</option>
                                        <option value="title_asc" @if($sortby == 'title_asc') selected @endif >Title: A - Z</option>
                                        <option value="title_desc" @if($sortby == 'title_desc') selected @endif >Title: Z - A</option>
                                        <option value="popular" @if($sortby == 'popular') selected @endif >Popularity</option>
                                    </select>
                                   </form>
                                </div>
                            </div>
                    ...
                    <div class="shop__sidebar__brand">
                        <ul>
                            @foreach(getallBrands() as $brand)
                                    <li class="@if(!empty($brandArray)) @if(in_array($brand->id,$brandArray)) active @endif @endif"><a href="{{route('view.product.brand',['productbrandSlug' => $brand->slug])}}">{{$brand->name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
