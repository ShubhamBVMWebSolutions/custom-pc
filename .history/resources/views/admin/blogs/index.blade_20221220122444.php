                                                   ...
                                                   @foreach($blogs as $key=>$row)
                                                     <tr id="tbl_record_{{$row->id}}">
                                                        ...
                                                        <td>
                                                          ...
                                                          <a href="javascript:void(0)" class="ajax_delete_blog" id="category_{{$row->id}}"><i class="ik ik-trash-2 f-16 text-red" data-toggle="tooltip" data-original-title="Click here for delete it"></i></a>
                                                    </tr>
                                                    @endforeach
                                                    @endif
                                                </tbody>
