...
$newsletterLinks = ['admin.newsletter.subscribers','admin.newsletter.list','admin.newsletter.create','admin.newsletter.show'];
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item {{$menu_open}}">
          ...
          <li class="nav-item {{$menu_open}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                 <a href="{{route('admin.newsletter.subscribers')}}" class="nav-link @if($route_name == 'admin.newsletter.subscribers') active @endif">
                  <p><b>Subscribers</b></p>
                </a>
              </li>
              <li class="nav-item">
                 <a href="{{route('admin.newsletter.list')}}" class="nav-link @if($route_name == 'admin.newsletter.list') active @endif">
                  <p><b>Newsletter List</b></p>
                </a>
              </li>
              <li class="nav-item">
                 <a href="{{route('admin.newsletter.create')}}" class="nav-link @if($route_name == 'admin.newsletter.create') active @endif">
