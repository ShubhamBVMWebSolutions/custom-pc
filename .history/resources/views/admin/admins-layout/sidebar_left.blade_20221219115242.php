...
$newsletter = ['newsletter.subscribers','newsletter.list','newsletter.create','newsletter.show'];
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item {{$menu_open}}">
          ...
          <li class="nav-item {{$menu_open}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                 <a href="{{route('newsletter.subscribers')}}" class="nav-link @if($route_name == 'admin.chipset' || $route_name == 'admin.update.chipset') active @endif">
                  <p><b>Subscribers</b></p>
                </a>
              </li>
              <li class="nav-item">
                 <a href="{{route('newsletter.create')}}" class="nav-link @if($route_name == 'admin.chipset.subcat' || $route_name == 'admin.add.update.chipset.subcat') active @endif">
