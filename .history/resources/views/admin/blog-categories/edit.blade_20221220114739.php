        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample"
                    action="{{ route('admin.blog-categories.update',[base64_encode($category->id)]) }}" method="post"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="product_category_id" class="form-control">
                                            ...
                                            <option value="{{$pcat->id}}" @if($category->product_category_id ==
                                                $pcat->id) selected @endif> {{$pcat->title}}</option>
                                            @endforeach
