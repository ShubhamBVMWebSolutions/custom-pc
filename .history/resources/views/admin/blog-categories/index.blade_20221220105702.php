                                                   ...
                                                   @foreach($blogCat as $key=>$category)
                                                     <tr id="tbl_record_{{$category->id}}">
                                                        ...
                                                        <td>
                                                          ...
                                                          <a href="javascript:void(0)" class="delete_blog_category" id="category_{{$category->id}}"><i class="ik ik-trash-2 f-16 text-red" data-toggle="tooltip" data-original-title="Click here for delete it"></i></a>
                                                    </tr>
                                                    @endforeach
                                                    @endif
                                                </tbody>
