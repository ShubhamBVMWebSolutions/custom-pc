            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <h5><a href="{{route('admin.product.category.view')}}"><i class="ik ik-edit bg-blue"></i> View
                                All</a></h5>
                        <div class="d-inline">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control"
                                                ...
                                                value="{{$productcatDetail->title ?? old('title')}}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="content" rows="5" class="form-control" name="description"
                                                placeholder="Category Description">{{$productcatDetail->description?? old('description')}}</textarea>
                                        </div>
                                    </div>
                                </div>
