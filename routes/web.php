...
Route::get('test-code',[App\Http\Controllers\Controller::class,'test_code']);
...
Route::get('auth/twitter',[App\Http\Controllers\Auth\TwitterController::class,'redirectToTwitter'])->name('twitter.auth');

Route::get('twitter/callback',[App\Http\Controllers\Auth\TwitterController::class,'handleTwitterCallback'])->name('twitter.callback');

Route::get('auth/instagram',[App\Http\Controllers\Auth\InstagramController::class,'redirectToInstagram'])->name('instagram.auth');

Route::get('instagram/callback',[App\Http\Controllers\Auth\InstagramController::class,'handleInstagramCallback'])->name('instagram.callback');

//newsletter

Route::post('news-letter-submit',[App\Http\Controllers\NewsletterController::class,'submit'])->name('newsletter.submit');
Route::get('news-letter-verify/{id}/{token}',[App\Http\Controllers\NewsletterController::class,'verify'])->name('newsletter.verify');
...
Route::any('/privacy-policy', [App\Http\Controllers\PagesController::class, 'privacy_policy'])->name('privacy-policy');
Route::any('/terms-and-conditions', [App\Http\Controllers\PagesController::class, 'terms_and_conditions'])->name('terms-and-conditions');
...
Route::match(['get','post'],'/search-suggestions', [App\Http\Controllers\SearchResultController::class, 'searchSuggestions'])->name('search.suggestions');
Route::match(['get','post'],'/search-product-suggestions', [App\Http\Controllers\SearchResultController::class, 'searchProductSuggestions'])->name('search.product.suggestions');
...
//new at SOI
Route::get('/new-at-soi',[App\Http\Controllers\ProductFilterController::class,'new_at_soi'])->name('view.new-at-soi');
...
// //paypal route
Route::any('/checkout/payment/paypal', [App\Http\Controllers\PaypalController::class, 'paywithpaypal'])->name('payment.paypal');
Route::get('/success/{order_id}',[App\Http\Controllers\PaypalController::class,'success'])->name('success');
Route::get('error',[App\Http\Controllers\PaypalController::class,'error'])->name('paypal_error');



// //paypal route
Route::any('/checkout/payment/stripe', [App\Http\Controllers\StripeController::class, 'paywithpaypal'])->name('payment.paypal');
Route::get('/success/{order_id}',[App\Http\Controllers\StripeController::class,'success'])->name('success');
Route::get('error',[App\Http\Controllers\StripeController::class,'error'])->name('paypal_error');
...
//user login
Route::any('/mobile-login',[App\Http\Controllers\Auth\LoginController::class,'mobile_login'])->name('mobile-login');
...
Route::middleware(['auth'])->group(function()
{
    ...
    Route::post('/submit/product-review',[App\Http\Controllers\MyAccountController::class,'productReview'])->name("submit.product-review");

    //wishlist

    Route::post('/toggle-wishlist-product', [App\Http\Controllers\WishlistController::class, 'toggle_wishlist_product'])->name('ajax.toggle-wishlist-product');
    Route::get('/my-account/wishlist', [App\Http\Controllers\WishlistController::class, 'index'])->name('user.dashboard.wishlist');
    Route::get('/clear-wishlist', [App\Http\Controllers\WishlistController::class, 'clear_wishlist'])->name('request.clear-wishlist');
...
// Blogs
 Route::get('/blogs/stack', [App\Http\Controllers\BlogController::class, 'blog_index'])->name('blog.index');
 Route::get('/blogs/single/{category_slug}/{type_slug}/{blog_slug}', [App\Http\Controllers\BlogController::class, 'blog_single'])->name('blog.single');
 Route::get('/blogs/category/{category_slug}', [App\Http\Controllers\BlogController::class, 'blog_category'])->name('blog.category');

//product Collections
Route::get('/product-collection/{slug}', [App\Http\Controllers\ProductCollectionController::class, 'index'])->name('view.product-collection');



// Stores
 Route::get('/stores', [App\Http\Controllers\StoreFinderController::class, 'index'])->name('stores.index');
 Route::get('/stores/single/{store_slug}', [App\Http\Controllers\StoreFinderController::class, 'single'])->name('stores.single');
 Route::get('/stores/near-search/{postcode}', [App\Http\Controllers\StoreFinderController::class, 'near_search'])->name('stores.near-search');

// Catalogues
 Route::get('/catalogues', [App\Http\Controllers\CatalogueController::class, 'index'])->name('catalogues.index');
 Route::get('/catalogues/single/{id}', [App\Http\Controllers\CatalogueController::class, 'single'])->name('catalogues.single');

// chat between admin and client

Route::get('/messages/{first_person_email}/{second_person_email}', [App\Http\Controllers\ChatController::class, 'index'])->name('messages.index');
Route::post('/send-message', [App\Http\Controllers\ChatController::class, 'send_message'])->name('messages.send-message');
Route::get('/get-new-messages/{conversation_id}/{sender_id}/{sender_type}', [App\Http\Controllers\ChatController::class, 'get_new_messages'])->name('messages.get-new-messages');
...
Route::prefix('/web-admin/')->middleware(['IsAdmin'])->name('admin.')->group(function()
    {
       ...
       Route::match(['POST','GET'],'/manage-privacy-policy',[App\Http\Controllers\Admin\PagesController::class,'update_privacy_policy'])->name('update.privacy-policy');
       Route::match(['POST','GET'],'/manage-terms-and-conditions',[App\Http\Controllers\Admin\PagesController::class,'update_terms_and_conditions'])->name('update.terms-and-conditions');


        //admin home page section change status
        Route::match(['POST','GET'],'/homesection/changeStatus',[App\Http\Controllers\Admin\PagesController::class,'HomeSectionChangeStatus'])->name('home-section-change-status');
      ...
      //import export routes
       ...
       //newsletters
        Route::get('/newsletter-subscribers',[App\Http\Controllers\Admin\NewsletterController::class,
            'subscribers'])->name('newsletter.subscribers');
        Route::get('/newsletter-list',[App\Http\Controllers\Admin\NewsletterController::class,
            'list'])->name('newsletter.list');
        Route::get('/newsletter-create',[App\Http\Controllers\Admin\NewsletterController::class,
            'create'])->name('newsletter.create');
        Route::post('/newsletter-send',[App\Http\Controllers\Admin\NewsletterController::class,
            'send'])->name('newsletter.send');
        Route::get('/newsletter-show/{id}',[App\Http\Controllers\Admin\NewsletterController::class,
            'show'])->name('newsletter.show');

        // product review

        Route::get('/reviews',[App\Http\Controllers\Admin\ProductReviewController::class,
            'index'])->name('reviews.index');
        Route::get('/reviews/update-status/{id}/{status}',[App\Http\Controllers\Admin\ProductReviewController::class,
            'update_status'])->name('reviews.update-status');
        Route::match(['POST','GET'],'/reviews/destroy',[App\Http\Controllers\Admin\ProductReviewController::class,
            'destroy'])->name('reviews.destroy');

        // conversations
        Route::get('/conversations',[App\Http\Controllers\Admin\ConversationController::class,
            'index'])->name('conversations.index');
        Route::match(['POST','GET'],'/conversations/destroy',[App\Http\Controllers\Admin\ConversationController::class,
            'destroy'])->name('conversations.destroy');
        //performances
        Route::get('/pc-performances',[App\Http\Controllers\Admin\PcPerformanceController::class,'index'])->name('pc-performances.index');
        Route::post('/pc-performances/update-or-insert',[App\Http\Controllers\Admin\PcPerformanceController::class,'updateOrInsert'])->name('pc-performances.update-or-insert');
        ...
        Route::resources([
            ...
            'product-collections' => App\Http\Controllers\Admin\ProductCollectionController::class,
            'stores' => App\Http\Controllers\Admin\StoreController::class,
            'catalogues' => App\Http\Controllers\Admin\CatalogueController::class,
            'new-product-blogs' => App\Http\Controllers\Admin\NewProductBlogController::class,
            'pc-budgets' => App\Http\Controllers\Admin\PcBudgetController::class
        ]);
        //highlightproducts
        Route::get('/highlightproducts',[App\Http\Controllers\Admin\HighlightproductController::class,'index'])->name('highlightproduct.index');
        Route::put('/highlightproducts',[App\Http\Controllers\Admin\HighlightproductController::class,'update'])->name('highlightproduct.update');
        //Advertisement
        Route::get('/advertisements',[App\Http\Controllers\Admin\AdvertisementController::class,'index'])->name('advertisement.index');
        Route::put('/advertisements',[App\Http\Controllers\Admin\AdvertisementController::class,'update'])->name('advertisement.update');
