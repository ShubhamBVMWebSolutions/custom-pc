...
<!-- Intro Section -->
@php if(isset($metaDetails->banner) && !empty($metaDetails->banner)){$bannerImg = url(Config::get('constants.SITE_PRODUCT_IMAGE').$metaDetails->banner );  }else{ $bannerImg = asset('public/img/pc-697642_960_720.jpg'); } @endphp
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div>
                        <a href="{{route('view.product-collection',[$metaDetails->slug])}}">Clear Filter</a>
                    </div>
