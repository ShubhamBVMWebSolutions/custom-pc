...
@section('title', 'Add/Update Screen Size')
@section('content')
            ...
            <div class="row align-items-end">
               <div class="col-lg-8">
                  <div class="page-header-title">
                     ...
                     <div class="d-inline">
                        <h5>{{Config::get('constants.ADMIN_PAGE_TITLE.ADD_UPDATE_SCREEN')}}</h5>
            ...
            <div class="col-md-8">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <form class="forms-sample" action="{{route('admin.add.update.screen.attr',['encScreenAttrId'=>$screenDetail->id])}}" method="post" enctype="multipart/form-data">
                        @else
                     <form class="forms-sample" action="{{route('admin.add.update.screen.attr')}}" method="post" enctype="multipart/form-data">
                        @endif
                        @csrf
