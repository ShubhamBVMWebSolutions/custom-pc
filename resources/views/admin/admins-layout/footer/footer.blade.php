...
<!--<script src="{{asset('admin-panel/dist/js/theme.min.js')}}"></script>-->
<script src="{{asset('admin-panel/js/form-components.js')}}"></script>
...
<script src="{{asset('admin-panel/plugins/jquery-knob/dist/jquery.knob.min.js')}}"></script>
...
<script src="{{asset('admin-panel/plugins/summernote/dist/summernote-bs4.min.js')}}"></script>
...
<script src="{{asset('admin-panel/admin_custom_js.js')}}"></script>
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>


<script src="{{asset('admin-panel/plugins/datatables.net/js/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('admin-panel/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js')}}"></script>
<script src="{{asset('admin-panel/js/datatables.js')}}"></script>
<script src="{{asset('admin-panel/plugins/datatables.net-responsive/js/dataTables.responsive.min.js')}}"></script>
<script src="{{asset('admin-panel/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js')}}"></script>





<script src="{{asset('admin-panel/plugins/moment/moment.js')}}"></script>
<script src="{{asset('admin-panel/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js')}}"></script>
<script src="{{asset('admin-panel/plugins/d3/dist/d3.min.js')}}"></script>
<script src="{{asset('admin-panel/plugins/c3/c3.min.js')}}"></script>
<script src="{{asset('admin-panel/js/tables.js')}}"></script>

<script src="{{asset('admin-panel/js/charts.js')}}"></script>
...
<script src="{{asset('datetime_picker/js/bootstrap-datetimepicker.js')}}"></script>
...
<script src="{{asset('sweet-alert/js/sweetalert.min.js')}}"></script>
<link rel="stylesheet" href="{{asset('sweet-alert/css/sweetalert.min.css')}}">
<script>
