                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr id="tbl_record_{{$row->id}}">
                                        <td>{{$loop->index + 1 }}</td>
                                        <td>@if(!empty($row->image)) <img src="{{ url('public/uploads/blogs/'.$row->image)}}" width="50" alt="{{$row->title}}"> @endif</td>
                                        <td>{{$row->title ?? ''}}</td>
                                        <td>{{$row->blog_category->title ?? ''}}</td>
                                        <td>{{$row->type ?? ''}}</td>
                                        <td>{{ $row->published ?? '' }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" class="ajax_delete_blog"
                                                id="blog_{{$row->id}}" title="Delete"><i class="ik ik-trash-2 f-16 text-red"
                                                    data-toggle="tooltip"
