                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="product_ids[]"
                                            ...
                                            @if($products->count()>0)
                                                @if(!empty($blog->product_ids))
                                                    @php $prodIdArray = json_decode($blog->product_ids); @endphp
                                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="published" class="form-check-input" value="Draft"
                                                id="radioDraft" @if($blog->published == 'Draft') checked @endif>
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="published" class="form-check-input"
                                                value="Publish" id="radioPuiblish" @if($blog->published == 'Publish') checked @endif>
