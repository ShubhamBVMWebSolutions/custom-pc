        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample"
                    action="{{ route('admin.catalogues.update',[base64_encode($catalogue->id)]) }}" method="post"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                            placeholder="Enter Title" value="{{$catalogue->title}}" required>
                                        @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="start_date" class="form-control"
                                            placeholder="Enter start date" value="{{$catalogue->start_date}}" required>
                                        @error('start_date')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="end_date" class="form-control"
                                            placeholder="Enter end date" value="{{$catalogue->end_date}}" required>
                                        @error('end_date')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="status" class="form-check-input" value="Draft"
                                                id="radioDraft" @if($catalogue->status == 'Draft') checked @endif>
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="status" class="form-check-input"
                                                value="Publish" id="radioPuiblish" @if($catalogue->status == 'Publish') checked @endif>
