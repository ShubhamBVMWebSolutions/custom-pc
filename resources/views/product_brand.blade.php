...
@section('title',$productbranddetails[0]->name)
@section('meta_keywords',$productbranddetails[0]->meta_keywords ?? '')
@section('meta_description',$productbranddetails[0]->meta_description ?? '')
@section('content')

<?php $brand_id = $productbranddetails[0]->id; 
$sort_val = $_GET['sort'] ?? ''; 
        ...
        <div class="row">
             <div class="col-lg-12">
                 <div class="category_page_bar text-center">
                     <h2>{{$productbranddetails[0]->name}}</h2>
                     <?php echo $productbranddetails[0]->description ?? ''; ?>
                 </div>   
             </div>   
        </div> 
    </div>    
